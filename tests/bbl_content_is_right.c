...
void main()
{
	...
	char * exp = "\\begin{thebibliography}{1}\n\n"
				 "\\bibitem{Ablikim:2012dx}\n"
				 "M.~Ablikim {\\it{et al.}} (BESIII Collaboration), Phys. Lett. B {\\bf 710}, 594, (2012).\n\n"
				 ...
				 "\\bibitem{Ableev:1994bg}\n"
				 "V.G.~Ableev {\\it{et al.}}, Phys. Lett. B {\\bf 329}, 407, (1994).\n\n"
				 "\\bibitem{Baier:1973}\n"
